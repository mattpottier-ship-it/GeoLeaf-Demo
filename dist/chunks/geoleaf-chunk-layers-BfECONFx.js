import { L as Log, v as validateUrl, i as dispatchGeoLeafEvent, G as DOMSecurity, o as domCreate, M as events, T as TimerManager, I as createElement, p as getLabel, x as Config, N as StyleLoader, K as blockMapPropagation } from './geoleaf-chunk-core-utils-u0egMUiC.js';
import { G as GeoJSONCore, a as GeoJSONShared } from './geoleaf-chunk-geojson-BLYAjSTx.js';
import { L as Labels, a as LabelButtonManager, _ as _UIComponents } from './geoleaf-chunk-labels-DezXeuck.js';
import { L as Legend } from './geoleaf-chunk-legend-wy104b_O.js';
import { _ as _ThemeApplier } from './geoleaf-chunk-themes-D2pTtb1Q.js';
...
async function resolveWmtsTilesUrl(definition, signal) {
    ...
    const safeCapsUrl = validateUrl(capsUrl, ["http:", "https:"]);
    if (!safeCapsUrl) {
        Log.error("[GeoLeaf.WMTS] Invalid GetCapabilities URL:", capsUrl);
        return null;
    }
...
function registerBaseLayer(key, definition) {
    ...
    const hasExtendedType = ["image", "hillshade", "wmts", "wms"].includes(definition.type);
    ...
    if (definition.terrain?.enabled) {
        resolveTerrainConfig(definition, actualKey);
    }
}
...
//# sourceMappingURL=geoleaf-chunk-layers-BfECONFx.js.map
