import { L as Log, m as escapeHtml } from './geoleaf-chunk-core-utils-CrTxiE0o.js';

/**
 * GeoLeaf Route Layer Manager Module
 * Gestion des layers de routes
 */
...
const RouteLayerManager = {
    ...
    fireRouteLoadedEvents(map, routeLayer, coords) {
        try {
            ...
            Log.warn("[GeoLeaf.Route] Unable to fire event geoleaf:route:loaded.", e);
        }
...
//# sourceMappingURL=geoleaf-chunk-route-CjIPmU1R.js.map
