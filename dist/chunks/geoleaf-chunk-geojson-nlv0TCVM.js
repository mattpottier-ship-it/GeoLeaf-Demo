...
const getState$a = () => (GeoJSONShared && GeoJSONShared.state ? GeoJSONShared.state : _defaultState$1);
...
const getState$9 = () => (GeoJSONShared && GeoJSONShared.state ? GeoJSONShared.state : _defaultState);
let _popupDeps = null;
/**
...
async function _doLoadSingleLayerMapLibre(rawData, fromCache, def, layerId, layerLabel, state, Log) {
    ...
    const _perf = !!window.__GEOLEAF_PERF__;
...
Loader._loadSingleLayer = function (layerId, layerLabel, def, baseOptions) {
    ...
    return dataPromise
        ...
        return _doLoadSingleLayerMapLibre(rawData, fromCache, def, layerId, layerLabel, state, Log);
    })
        .then((result) => {
...
//# sourceMappingURL=geoleaf-chunk-geojson-nlv0TCVM.js.map
