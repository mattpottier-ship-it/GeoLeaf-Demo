import { L as Log, p as getLabel, M as events, G as DOMSecurity, I as createElement, P as getNestedValue } from './geoleaf-chunk-core-utils-u0egMUiC.js';
import { a as GeoJSONShared, V as VisibilityManager } from './geoleaf-chunk-geojson-BLYAjSTx.js';
...
function _attachResizeEvents(handle, container, config) {
    ...
    if (events$1) {
        _TablePanel._eventCleanups.push(events$1.on(handle, "mousedown", mouseDownHandler, false, "TablePanel.resizeMouseDown"));
        _TablePanel._eventCleanups.push(events$1.on(document, "mousemove", mouseMoveHandler, false, "TablePanel.resizeMouseMove"));
        _TablePanel._eventCleanups.push(events$1.on(document, "mouseup", mouseUpHandler, false, "TablePanel.resizeMouseUp"));
    }
    else {
...
function exportSelection() {
    ...
    try {
        downloadGeoJSON(buildGeoJSONCollection(selectedFeatures), tableState._currentLayerId ?? undefined);
...
//# sourceMappingURL=geoleaf-chunk-table-hFFWOW-j.js.map
