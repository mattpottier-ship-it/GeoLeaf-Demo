import { q as resolveField$1, L as Log, u as Security, x as Config, y as CONSTANTS, z as StyleResolver, g as getLog, A as getActiveProfile, B as compareByOrder, m as escapeHtml, D as getColorsFromLayerStyle, E as validateUrl, F as formatNumber$1, G as DOMSecurity, i as dispatchGeoLeafEvent, H as AbstractRenderer, p as getLabel, I as createElement, J as poisToFeatureCollection } from './geoleaf-chunk-core-utils-6omwf8Zx.js';
 ...
 * @internal
 */
function _rebuildPoiClusterSource(state, constants) {
    const _g = globalThis;
    const adapter = _g.GeoLeaf?.Core?.getAdapter?.();
    ...
    if (!nativeMap)
        return;
    try {
        // Recreate cluster source via adapter
...
async function _initMapLibrePoi(state, constants) {
    ...
    document.addEventListener("geoleaf:style:rebuild", () => {
        _rebuildPoiClusterSource(state, constants);
    });
...
//# sourceMappingURL=geoleaf-chunk-poi-DkHyWk11.js.map
