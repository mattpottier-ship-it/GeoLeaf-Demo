import { L as Log, v as validateUrl, i as dispatchGeoLeafEvent, G as DOMSecurity, o as domCreate, x as Config, M as StyleLoader, p as getLabel, K as blockMapPropagation } from './geoleaf-chunk-core-utils-CWXgIxbg.js';
import { G as GeoJSONCore, a as GeoJSONShared } from './geoleaf-chunk-geojson-nlv0TCVM.js';
import { L as Labels, a as LabelButtonManager, _ as _UIComponents } from './geoleaf-chunk-labels-D-oB63HP.js';
import { L as Legend } from './geoleaf-chunk-legend-BOgQISfA.js';
import { _ as _ThemeApplier } from './geoleaf-chunk-themes-v5fM1AxV.js';
...
function refreshBasemap() {
    if (!_map || !_activeKey || _activeType !== "raster")
        return;
    if (_map.getSource?.(BASEMAP_SOURCE_ID))
        return;
...
//# sourceMappingURL=geoleaf-chunk-layers-Bl4JW9rv.js.map
